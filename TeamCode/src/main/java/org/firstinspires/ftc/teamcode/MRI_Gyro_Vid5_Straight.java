...
public class MRI_Gyro_Vid5_Straight extends LinearOpMode {  //Linear op mode is being used so the program does not get stuck in loop()
    ...
    public void runOpMode() {
        ...
        MLeft = hardwareMap.dcMotor.get("left_drive");  //Config File
        ...
        MLeft.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);  //Install encoders to control the speed of the motors to be consistent even at different battery levels
