...
public class MRI_Gyro_Vid4_Turn extends LinearOpMode {   //Linear op mode is being used so the program does not get stuck in loop()
    ...
    public void runOpMode() {
        ...
        MLeft = hardwareMap.dcMotor.get("left_drive");  //Config File variable settings left_/right_drive
        MRight = hardwareMap.dcMotor.get("right_drive");
        ...
        MLeft.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);  //Install encoders if you want to control the speed of the motors to be consistent even at different battery levels
